/**
 * @fileoverview Guard Home Error Component - TraxYard Guard Interface
 * 
 * Error boundary component for the guard home page. Provides user-friendly
...
/**
 * Guard Home Error Component
 * 
 * Error boundary wrapper for the guard home page with dashboard-specific context.
 ...
 * 
 * @returns {JSX.Element} Error boundary with dashboard context
 * 
 * @accessibility
...
export default function Error({
  ...
  return <ErrorBoundary error={error} reset={reset} context="dashboard" />;
}
